const resume = `
 ...
 MERN Stack Developer with 3+ years of experience building scalable web applica
 ...
 Concepts: REST APIS, JWT Authentication, MVC Architect
...
Built authentication and authorization system using JWT and role-based acces
Implemented caching strategy using Redis (basic implementation).
Led migration from monolithic structure to modular service-based architectur
...
July 2021 -Dec 2022
 ...
 Developed dynamic UI components using React and Redu
Integrated third-party APIs including payment gatewa
Improved frontend performance by reducing bundle siz
Collaborated with design and QA teams to deliver pro
...
I am currently targeting backend developer roles where scalable systems and improve my expertise in distribut performance optimization.
`;
